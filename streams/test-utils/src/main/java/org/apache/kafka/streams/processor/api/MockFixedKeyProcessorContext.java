...
/**
 * {@link MockFixedKeyProcessorContext} is a mock of {@link FixedKeyProcessorContext} for users to test their {@link Processor}
 * {@link Transformer}, and {@link ValueTransformer} implementations using a fixed key.
 * <p>
 * The tests for this class (org.apache.kafka.streams.MockFixedKeyProcessorContext) include several behavioral
 ...
 */
public class MockFixedKeyProcessorContext<KForward, VForward> implements FixedKeyProcessorContext<KForward, VForward>, RecordCollector.Supplier {
    // Immutable fields ================================================
    ...
    public <K extends KForward, V extends VForward> void forward(Record<K, V> record) {
        forward(InternalFixedKeyRecordFactory.create(record), null);
    }
